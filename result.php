...
<div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
    ...
    <div class="col-lg-6 col-lg-push-3" style="min-height: 500px; background-color: white;">
      ...
      if(isset($_SESSION["answer"]))
      {
          ...
          {
            $answer="";
            $sql=mysqli_query($link,"select * from `questions` where category='$_SESSION[exam_category]' && question_no=$i");
      ...
      $sql=mysqli_query($link,"select * from `questions` where category='$_SESSION[exam_category]'");
