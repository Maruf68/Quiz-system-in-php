                                    ...
                                    <div class="card-header"><strong>Add new questions with images</strong>
                                        <div class="card-body card-block">
                                            ...
                                            <div class="form-group"><label for="company" class=" form-control-label">Add
                                                    ...
                                                    class="form-control" style="padding-bottom:35px" name="fopt1"></div>

                                            <div class="form-group"><label for="company" class=" form-control-label">Add
                                                    Option 2</label><input type="file"
                                                    class="form-control" style="padding-bottom:35px" name="fopt2"></div>

                                            <div class="form-group"><label for="company" class=" form-control-label">Add
                                                    Option 3</label><input type="file"
                                                    class="form-control" style="padding-bottom:35px" name="fopt3"></div>

                                            <div class="form-group"><label for="company" class=" form-control-label">Add
                                                    Option 4</label><input type="file"
                                                    class="form-control" style="padding-bottom:35px" name="fopt4"></div>

                                            <div class="form-group"><label for="company" class=" form-control-label">Add
                                                    Answer</label><input type="file"
                                                    class="form-control" name="fanswer"></div>
...
$loop =0;
  ...
  if($count==0){
     ...
     $loop=$loop+1;
       ...
       $dst_db1="opt_images/" . $tm. $fnm1;  //downloading image
